...
class User {
  constructor(userId, username, password, role, fullName, birthday, gender) {
    this.user_id = userId; // Added user_id
  ...
  static async create(user) {
    const query = `INSERT INTO Users (username, password, role, fullName, birthday, gender) VALUES ($1, $2, $3, $4, $5, $6) 
  ...
  static async update(userId, user) {
    const query = `UPDATE Users
        SET "fullname" = $1, "birthday" = $2, "gender" = $3 
        WHERE "user_id" = $4
        RETURNING "user_id", "username", "password", "role", "fullname", "birthday", "gender"`;;
